! function() {
    for (var e = document.querySelectorAll("h1[id],h2[id],h3[id],h4[id],h5[id],h6[id]"), t = 0; t < e.length; t++) {
        ...
        i.setAttribute("src", "/assets/img/link-symbol.svg");
...
var Zepto = function() {
    ...
    function i(t) {
        return "children" in t ? N.call(t.children) : b.map(t.childNodes, function(t) {
    ...
    return F.matches = function(t, e) {
        ...
        var i, r, o;
        return P.test(t) && (i = b(C.createElement(RegExp.$1))), i || (t.replace && (t = t.replace(Z, "<$1></$2>")), e === y && (e = O.test(t) && RegExp.$1), e in k || (e = "*"), (o = k[e]).innerHTML = "" + t, i = b.each(N.call(o.childNodes), function() {
            o.removeChild(this)
        })), c(n) && (r = b(i), b.each(n, function(t, e) {
        ...
        if ("string" == typeof t)
            ...
            if (F.isZ(t)) return t;
            if (J(t)) i = t, n = S.call(i, function(t) {
                return null != t
            });
    ...
    }, b.contains = C.documentElement.contains ? function(t, e) {
        return t !== e && t.contains(e)
    } : function(t, e) {
        for (; e && (e = e.parentNode);)
            if (e === t) return !0;
        return !1
    }, b.type = u, b.isFunction = a, b.isWindow = o, b.isArray = J, b.isPlainObject = c, b.isEmptyObject = function(t) {
        var e;
        for (e in t) return !1;
        return !0
    }, b.inArray = function(t, e, n) {
        return j.indexOf.call(e, t, n)
    }, b.camelCase = L, b.trim = function(t) {
        return null == t ? "" : String.prototype.trim.call(t)
    }, b.uuid = 0, b.support = {}, b.expr = {}, b.map = function(t, e) {
        var n, i, r, o, a = [];
        if (l(t))
        ...
        return S.call(t, e)
    }, window.JSON && (b.parseJSON = JSON.parse), b.each("Boolean Number String Function Array Date RegExp Object Error".split(" "), function(t, e) {
        ...
        concat: j.concat,
        map: function(n) {
            return b(b.map(this, function(t, e) {
                return n.call(t, e, t)
            }))
        },
        slice: function() {
        ...
        ready: function(t) {
            return _.test(C.readyState) && C.body ? t(b) : C.addEventListener("DOMContentLoaded", function() {
                t(b)
            }, !1), this
        },
        get: function(t) {
        ...
        filter: function(e) {
            return a(e) ? this.not(this.not(e)) : b(S.call(this, function(t) {
        ...
        not: function(e) {
            var n = [];
            if (a(e) && e.call !== y) this.each(function(t) {
        ...
        find: function(t) {
            var n = this;
            return t ? "object" == typeof t ? b(t).filter(function() {
                var e = this;
                return j.some.call(n, function(t) {
                    return b.contains(t, e)
                })
            }) : 1 == this.length ? b(F.qsa(this[0], t)) : this.map(function() {
                return F.qsa(this, t)
            }) : b()
        },
        ...
        parents: function(t) {
            for (var e = [], n = this; 0 < n.length;) n = b.map(n, function(t) {
        ...
        show: function() {
            return this.each(function() {
                var t, e, n;
                "none" == this.style.display && (this.style.display = ""), "none" == getComputedStyle(this, "").getPropertyValue("display") && (this.style.display = (t = this.nodeName, T[t] || (e = C.createElement(t), C.body.appendChild(e), n = getComputedStyle(e, "").getPropertyValue("display"), e.parentNode.removeChild(e), "none" == n && (n = "block"), T[t] = n), T[t]))
            })
        },
        ...
        prop: function(e, n) {
            return e = V[e] || e, 1 in arguments ? this.each(function(t) {
        ...
        css: function(t, e) {
            if (arguments.length < 2) {
                ...
                if (J(t)) {
                    var r = {};
                    return b.each(t, function(t, e) {
                        r[e] = i.style[L(e)] || n.getPropertyValue(e)
                    }), r
                }
            }
            var o = "";
            if ("string" == u(t)) e || 0 === e ? o = h(t) + ":" + f(t, e) : this.each(function() {
                this.style.removeProperty(h(t))
            });
            else
                for (x in t) t[x] || 0 === t[x] ? o += h(x) + ":" + f(x, t[x]) + ";" : this.each(function() {
        ...
        addClass: function(n) {
            return n ? this.each(function(t) {
                if ("className" in this) {
                    w = [];
                    var e = v(this);
                    d(this, n, t, e).split(/\s+/g).forEach(function(t) {
                        b(this).hasClass(t) || w.push(t)
                    }, this), w.length && v(this, e + (e ? " " : "") + w.join(" "))
                }
            }) : this
        },
        removeClass: function(e) {
            return this.each(function(t) {
                if ("className" in this) {
                    ...
                    w = v(this), d(this, e, t, w).split(/\s+/g).forEach(function(t) {
                        w = w.replace(n(t), " ")
                    }), v(this, w.trim())
                }
            })
        ...
        toggleClass: function(n, i) {
            return n ? this.each(function(t) {
                var e = b(this);
                d(this, n, t, v(this)).split(/\s+/g).forEach(function(t) {
        ...
        position: function() {
            if (this.length) {
                ...
                return n.top -= parseFloat(b(t).css("margin-top")) || 0, n.left -= parseFloat(b(t).css("margin-left")) || 0, i.top += parseFloat(b(e[0]).css("border-top-width")) || 0, i.left += parseFloat(b(e[0]).css("border-left-width")) || 0, {
                    top: n.top - i.top,
                    left: n.left - i.left
                }
            }
    ...
    }, b.fn.detach = b.fn.remove, ["width", "height"].forEach(function(i) {
        var r = i.replace(/./, function(t) {
            return t[0].toUpperCase()
        });
        b.fn[i] = function(e) {
            var t, n = this[0];
            return e === y ? o(n) ? n["inner" + r] : s(n) ? n.documentElement["scroll" + r] : (t = this.offset()) && t[i] : this.each(function(t) {
        ...
        var s = a % 2;
        b.fn[e] = function() {
            var e, i, r = b.map(arguments, function(t) {
    ...
    }), F.Z.prototype = b.fn, F.uniq = E, F.deserializeValue = g, b.zepto = F, b
}();
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto),
    function(l) {
        ...
        function c(r, t, e, o, a, s, u) {
            ...
            t.split(/\s/).forEach(function(t) {
                ...
                var n = f(t);
                n.fn = e, n.sel = a, n.e in E && (e = function(t) {
                ...
                }, n.i = c.length, c.push(n), "addEventListener" in r && r.addEventListener(d(n.e), n.proxy, p(n, u))
            })
        }
        ...
        function v(i, r) {
            ...
            }), (r.defaultPrevented !== y ? r.defaultPrevented : "returnValue" in r ? !1 === r.returnValue : r.getPreventDefault && r.getPreventDefault()) && (i.isDefaultPrevented = s)), i
        }
        ...
        l.fn.delegate = function(t, e, n) {
            ...
            return e && !w(e) ? (l.each(e, function(t, e) {
                i.on(t, r, n, e, a)
            }), i) : (w(r) || b(o) || !1 === o || (o = n, n = r, r = y), (b(n) || !1 === n) && (o = n, n = y), !1 === o && (o = j), i.each(function(t, i) {
                a && (s = function(t) {
            ...
            return t && !w(t) ? (l.each(t, function(t, e) {
                i.off(t, n, e)
            }), i) : (w(n) || b(e) || !1 === e || (e = n, n = y), !1 === e && (e = j), i.each(function() {
                m(this, t, e, n)
            }))
        }, l.fn.trigger = function(t, e) {
            return (t = w(t) || l.isPlainObject(t) ? l.Event(t) : v(t))._args = e, this.each(function() {
            ...
            return this.each(function(t, e) {
                (r = g(w(n) ? l.Event(n) : n))._args = i, r.target = e, l.each(a(e, n.type || n), function(t, e) {
    ...
    function(dh) {
        ...
        function qh(t, e, n, i) {
            return dh.isFunction(e) && (i = n, n = e, e = void 0), dh.isFunction(n) || (i = n, n = void 0), {
                url: t,
                data: e,
                success: n,
                dataType: i
        ...
        Ch.href = window.location.href, dh.active = 0, dh.ajaxJSONP = function(n, i) {
            ...
            return i && i.promise(c), dh(s).on("load error", function(t, e) {
            ...
            }), !1 === ih(c, n) ? e("abort") : (window[a] = function() {
                r = arguments
            }, s.src = n.url.replace(/\?(.+)=\?/, "?$1=" + a), vh.head.appendChild(s), 0 < n.timeout && (o = setTimeout(function() {
                e("timeout")
            }, n.timeout))), c
        }, dh.ajaxSettings = {
            type: "GET",
            ...
            var Ki, ii, Mh, Li = dh.extend({}, Ji || {}),
                Mi = dh.Deferred && dh.Deferred();
            for (sh in dh.ajaxSettings) void 0 === Li[sh] && (Li[sh] = dh.ajaxSettings[sh]);
            (Mh = Li).global && 0 == dh.active++ && fh(Mh, null, "ajaxStart"), Li.crossDomain || ((Ki = vh.createElement("a")).href = Li.url, Ki.href = Ki.href, Li.crossDomain = Ch.protocol + "//" + Ch.host != Ki.protocol + "//" + Ki.host), Li.url || (Li.url = window.location.toString()), (ii = Li).processData && ii.data && "string" != dh.type(ii.data) && (ii.data = dh.param(ii.data, ii.traditional)), !ii.data || ii.type && "GET" != ii.type.toUpperCase() || (ii.url = oh(ii.url, ii.data), ii.data = void 0);
            var Ni = Li.dataType,
                Oi = /\?.+=\?/.test(Li.url);
            if (Oi && (Ni = "jsonp"), !1 !== Li.cache && (Ji && !0 === Ji.cache || "script" != Ni && "jsonp" != Ni) || (Li.url = oh(Li.url, "_=" + Date.now())), "jsonp" == Ni) return Oi || (Li.url = oh(Li.url, Li.jsonp ? Li.jsonp + "=?" : !1 === Li.jsonp ? "" : "callback=?")), dh.ajaxJSONP(Li, Mi);
            ...
            if (Mi && Mi.promise(Ui), Li.crossDomain || Si("X-Requested-With", "XMLHttpRequest"), Si("Accept", Qi || "*/*"), (Qi = Li.mimeType || Qi) && (-1 < Qi.indexOf(",") && (Qi = Qi.split(",", 2)[0]), Ui.overrideMimeType && Ui.overrideMimeType(Qi)), (Li.contentType || !1 !== Li.contentType && Li.data && "GET" != Li.type.toUpperCase()) && Si("Content-Type", Li.contentType || "application/x-www-form-urlencoded"), Li.headers)
            ...
            if (Ui.setRequestHeader = Si, !(Ui.onreadystatechange = function() {
                    if (4 == Ui.readyState) {
                        ...
                        if (200 <= Ui.status && Ui.status < 300 || 304 == Ui.status || 0 == Ui.status && "file:" == Ti) {
                            Ni = Ni || ((fi = Li.mimeType || Ui.getResponseHeader("content-type")) && (fi = fi.split(";", 2)[0]), fi && (fi == Ah ? "html" : fi == zh ? "json" : xh.test(fi) ? "script" : yh.test(fi) && "xml") || "text"), Zi = Ui.responseText;
                            try {
                    ...
                    var fi
                }) === ih(Ui, Li)) return Ui.abort(), kh(null, "abort", Ui, Li, Mi), Ui;
            if (Li.xhrFields)
                for (th in Li.xhrFields) Ui[th] = Li.xhrFields[th];
            ...
            }, Li.timeout)), Ui.send(Li.data ? Li.data : null), Ui
        }, dh.get = function() {
    ...
    function(o) {
        o.fn.serializeArray = function() {
            ...
            return this[0] && o.each(this[0].elements, function(t, e) {
                i = e.type, (n = e.name) && "fieldset" != e.nodeName.toLowerCase() && !e.disabled && "submit" != i && "reset" != i && "button" != i && "file" != i && ("radio" != i && "checkbox" != i || e.checked) && r(o(e).val())
            }), e
...
! function(e, o) {
    ...
    return function(e, o) {
        ...
        function D(e) {
            var o = e || {};
            void 0 !== o.cookieExpire && (a = k(o.cookieExpire)), !0 === o.sitewide && (m = ";path=/"), void 0 !== o.cookieDomain && (s = ";domain=" + o.cookieDomain), void 0 !== o.cookieName && (d = o.cookieName), document.cookie = d + "=true" + a + s + m, v.removeEventListener("mouseleave", p), v.removeEventListener("mouseenter", y), v.removeEventListener("keydown", b)
        }
        return {
            fire: w,
            disable: D,
...
! function() {
    ...
    var e, t = document.querySelector(".recommendation"),
        n = !1;
    t && (t.querySelector(".message button").addEventListener("click", function() {
        return o(), !1
    }), document.addEventListener("stillReading", function(e) {
        n && (t.style.bottom = "-100%", n = !1)
    }, !1), document.addEventListener("finishedReading", function(e) {
...
! function(n) {
    ...
    function t(t, e) {
        this.el = t, this.options = function(t, e) {
            for (var i in e) e.hasOwnProperty(i) && (t[i] = e[i]);
            return t
        }(this.defaults, e), this._init()
    }
    t.prototype = {
        defaults: {
            minDuration: 0,
        ...
        _scrollPage: function() {
            ...
            this.items.forEach(function(i, t) {
                classie.has(i, "shown") || classie.has(i, "animate") || !o(i, n.options.viewportFactor) || setTimeout(function() {
                    var t = a() + s() / 2;
                    if (n.el.style.WebkitPerspectiveOrigin = "50% " + t + "px", n.el.style.MozPerspectiveOrigin = "50% " + t + "px", n.el.style.perspectiveOrigin = "50% " + t + "px", n._checkTotalRendered(), n.options.minDuration && n.options.maxDuration) {
...
! function(c) {
    c.fn.simpleJekyllSearch = function(e) {
        ...
        l.jsonFile.length && i.length && c.ajax({
            type: "GET",
            url: l.jsonFile,
            dataType: "json",
            success: function(e, t, n) {
                o = e, s.keyup(function(e) {
                    var t, n, s;
                    c(this).val().length ? (n = c(this).val(), s = [], c.each(o, function(e, t) {
                        for (e = 0; e < a.length; e++) void 0 !== t[a[e]] && -1 !== t[a[e]].toLowerCase().indexOf(n.toLowerCase()) && (s.push(t), e = a.length)
                    }), t = s, r(), i.append(c(l.searchResultsTitle)), t.length ? c.each(t, function(e, t) {
                        if (e < l.limit) {
...
! function(e, t) {
    ...
    o.animateScroll = function(i, u, e) {
        var t, n = (t = i ? i.getAttribute("data-options") : null) && "object" == typeof JSON && "function" == typeof JSON.parse ? JSON.parse(t) : {},
            s = I(s || S, e || {}, n),
            l = "#" === (u = "#" + function(e) {
                for (var t, n = String(e), o = n.length, r = -1, a = "", c = n.charCodeAt(0); ++r < o;) {
                    ...
                    a += 1 <= t && t <= 31 || 127 == t || 0 === r && 48 <= t && t <= 57 || 1 === r && 48 <= t && t <= 57 && 45 === c ? "\\" + t.toString(16) + " " : 128 <= t || 45 === t || 95 === t || 48 <= t && t <= 57 || 65 <= t && t <= 90 || 97 <= t && t <= 122 ? n.charAt(r) : "\\" + n.charAt(r)
                }
                return a
            }(u.substr(1))) ? y.document.documentElement : y.document.querySelector(u),
            f = y.pageYOffset;
        c || (c = y.document.querySelector(s.selectorHeader)), O || (O = H(c));
        var d, h, p, o, r, m = function(e, t, n) {
                var o = 0;
                if (e.offsetParent)
            ...
            v = 0;
        o = u, r = s.updateURL, y.history.pushState && (r || "true" === r) && "file:" !== y.location.protocol && y.history.pushState(null, null, [y.location.protocol, "//", y.location.host, y.location.pathname, y.location.search, o].join(""));
        var a = function() {
            var e, t, n, o, r, a, c;
            h = 1 < (h = (v += 16) / parseInt(s.speed, 10)) ? 1 : h, p = f + g * (e = s.easing, t = h, "easeInQuad" === e && (n = t * t), "easeOutQuad" === e && (n = t * (2 - t)), "easeInOutQuad" === e && (n = t < .5 ? 2 * t * t : (4 - 2 * t) * t - 1), "easeInCubic" === e && (n = t * t * t), "easeOutCubic" === e && (n = --t * t * t + 1), "easeInOutCubic" === e && (n = t < .5 ? 4 * t * t * t : (t - 1) * (2 * t - 2) * (2 * t - 2) + 1), "easeInQuart" === e && (n = t * t * t * t), "easeOutQuart" === e && (n = 1 - --t * t * t * t), "easeInOutQuart" === e && (n = t < .5 ? 8 * t * t * t * t : 1 - 8 * --t * t * t * t), "easeInQuint" === e && (n = t * t * t * t * t), "easeOutQuint" === e && (n = 1 + --t * t * t * t * t), "easeInOutQuint" === e && (n = t < .5 ? 16 * t * t * t * t * t : 1 + 16 * --t * t * t * t * t), n || t), y.scrollTo(0, Math.floor(p)), o = p, r = m, a = d, c = y.pageYOffset, (o == r || c == r || y.innerHeight + c >= b) && (clearInterval(a), l.focus(), s.callback(i, u))
        };
...
! function() {
    ...
    if (e && v) {
        ...
        document.addEventListener("scroll", function() {
            var e, t, n = window.pageYOffset || document.documentElement.scrollTop;
            if (v.style.bottom = g < n && y ? "0%" : "-100%", n <= E) {
                ...
                c = c < 10 ? "0" + c : c, d = d < 10 ? "0" + d : d, l = l < 10 ? "0" + l : l, m = m < 10 ? "0" + m : m, f.innerText = c + ":" + d, I.innerText = l + ":" + m, y = !0, (t = document.createEvent("CustomEvent")).initCustomEvent("stillReading"), document.dispatchEvent(t)
            } else {
...
! function(o, e, a) {
    ...
    var l = {
        close: o(".icon-remove-sign"),
        searchform: o(".search-form"),
        canvas: o("body"),
        dothis: o(".dosearch")
    };
    ...
    }), l.close.on("click", n), document.addEventListener("keyup", function(e) {
